...
function JSONSilo(options) {
  ...
  /*
  require('./routes/savedata')(self.app, self.silomanager);
  require('./routes/getunencrypted')(self.app, self.silomanager);
  ...
  require('./routes/getencrypted')(self.app, self.silomanager);*/
