...
function JSONSilo(options) {
  ...
  require('./routes/reelyactiveregister')(this.app, this.silomanager);
  require('./routes/reelyactiveremove')(this.app, this.silomanager);
  require('./routes/getencrypted')(this.app, this.silomanager);
